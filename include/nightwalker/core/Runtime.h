...
private:
 ...
 game::GameContext gameContext_{};util::Logger logger_{};Config config_{};SafetyWatchdog watchdog_{};DebugInput debugInput_{};game::GameApi gameApi_{};game::GameCombatApi gameCombatApi_{};game::GameFeedingApi gameFeedingApi_{};game::GameMovementApi gameMovementApi_{};game::GamePresentationApi gamePresentationApi_{};systems::DebugVampireSpawner debugVampireSpawner_;systems::ShadowstepController shadowstepController_;systems::VampireAIController vampireAiController_;systems::MovementController movementController_;systems::FeedingController feedingController_;std::vector<ILifecycleSystem*> systems_{};util::Deadline debugDebounce_{};std::uint64_t tickCount_{0};std::uint64_t lastTickMs_{0};bool unsafeState_{false};bool initialized_{false};
};
}
